...
const AIPostsSection: React.FC<AIPostsSectionProps> = ({
  posts,
  createPostContent,
  title = "AI Posts",
  emptyMessage = "No AI posts found."
}) => {
  if (posts.length === 0) {
    return (
      <section className="mb-16"> {/* Changed mb-12 to mb-16 */}
